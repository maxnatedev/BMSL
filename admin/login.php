...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .login-card h1 { font-size: 1.5rem; color: #0B1F33; text-align: center; margin-bottom: 0.5rem; }
        .login-card p { font-size: 0.9rem; color: #6B7280; text-align: center; margin-bottom: 2rem; }
