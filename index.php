    ...
    <div class="container">
        ...
        <div class="contact-grid">
            <div class="contact-info animate-in-left">
                ...
                <div class="contact-detail"><span class="contact-detail-icon">&#9906;</span><div><h4><?= escape($content['contact_label_address'] ?? 'Address') ?></h4><p><?= escape($content['contact_address'] ?? 'Nyamongo, Tarime, Tanzania') ?></p></div></div>
                <div class="contact-detail"><span class="contact-detail-icon">&#9742;</span><div><h4><?= escape($content['contact_label_phone'] ?? 'Phone') ?></h4><p><a href="tel:<?= escape($content['contact_phone'] ?? '') ?>"><?= escape($content['contact_phone'] ?? '+255 762 784 531') ?></a></p></div></div>
                <div class="contact-detail"><span class="contact-detail-icon">&#9993;</span><div><h4><?= escape($content['contact_label_email'] ?? 'Email') ?></h4><p><a href="mailto:<?= escape($content['contact_email1'] ?? 'info@bmsl.co.tz') ?>"><?= escape($content['contact_email1'] ?? 'info@bmsl.co.tz') ?></a><?php if (!empty($content['contact_email2'])): ?><br><a href="mailto:<?= escape($content['contact_email2']) ?>"><?= escape($content['contact_email2']) ?></a><?php endif; ?></p></div></div>
                <div class="contact-detail"><span class="contact-detail-icon">&#127760;</span><div><h4><?= escape($content['contact_label_website'] ?? 'Website') ?></h4><p><a href="https://<?= escape($content['contact_website'] ?? 'bmsl.co.tz') ?>"><?= escape($content['contact_website'] ?? 'www.bmsl.co.tz') ?></a></p></div></div>
